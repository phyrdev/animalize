...
function EditFacilityContainer({ o_facility }) {
  ...
  const [pFacility, setPFacility] = React.useState({
    name: o_facility.name || "",
    cost: o_facility.cost || "",
    duration: o_facility.duration || "",
    availability: o_facility.availability || "",
    parameters: o_facility.parameters || [],
  });
...
export default EditFacilityContainer;

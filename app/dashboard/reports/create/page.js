          ...
          <>
            {selectTestsOpen && (
              <div className="fixed inset-0 h-full w-full bg-black/50 flex items-end md:items-center justify-center z-20">
                <div className="min-h-[400px] h-fit md:h-fit max-h-[600px] w-full md:w-[550px] bg-white md:rounded-md relative overflow-auto pb-4">
                  <div className="sticky top-0 inset-x-0 bg-white">
                    <div className="p-5 flex items-center">
                      ...
                      <Button
                        onClick={() => setSelectTestsOpen(false)}
                        className="rounded bg-neutral-900 text-white ml-auto"
                      >
                        Done
                      </Button>
                    </div>
